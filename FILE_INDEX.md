...
| `debug/a-main/g3-comparator-ss/g3-shipping-headtohead-results.md` | SUT-2 shipping head-to-head RESULTS (live, kind cluster): 2×2 matrix (natural/constructed × P2-amended/as-frozen). Pilot b8cyz1t9m: MIST FIREs all 4; as-frozen comparator MISSES both; P2 comparator CAUGHT natural (diagnosis-gap) + MISSED constructed (clean win) → clean win robust to in-class strengthening. Method + reviewer-mandated framing + live-confirms; N=5 stability appended from bqf1d09h4 |
