...
| `debug/a-main/OVERVIEW.md` | **Presentation-oriented English project overview**: problem (acknowledged-but-lost writes), approach + positioning vs Cast, mechanism (read-back oracle + fault-injection scaffolding), the fair blind comparator (closed primitive set + ContractEvaluator), the G1/G2/G3 gates, results (Gate-1 PASS, cancel→refund + Sock Shop head-to-heads, breadth, FP), and honest scope/threats-to-validity |
