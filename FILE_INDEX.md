...
| `debug/a-main/g3-comparator-tt/runs/` | Persisted head-to-head run logs (prefunded-run*.log, prefunded-reps.txt) — machine-readable evidence with the value-delta probe balances, addressing review B's "persist run records" |
