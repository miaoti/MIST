...
def render(case_path, sidecar_path, opaque_id, out_dir, sut_doc_note=None):
    ...
    ballot = (
        ...
        "ack_carries_failure_sentinel:   # yes | no | n/a — MECHANICAL, not a judgment: does a\n"
        "                                #   2xx-success ack carry an in-body failure sentinel?\n"
        "                                #   n/a if the ack is NOT a 2xx success (e.g. an HTTP 4xx).\n"
