...
- `t+111ms`  **POST /tools.descartes.teastore.webui/cartAction?firstname=corpus-marker&lastname=Corpus&address1=Street1&address2=City1&cardtype=visa&cardnumber=314159265359&expirydate=12%2F2029&confirm=Confirm**
  - response: HTTP 200 — body: `<success-shaped page rendered>`
...
- `t+120670ms`  observed state via `GET /tools.descartes.teastore.persistence/rest/orders/user/{id} (parent order) — read in a later verification pass`: HTTP 200 — `parent order 'corpus-marker': PRESENT`
