...
> = **8 live-run + 1 manual-record + 0 capture-concordant** (9 flags). History: was 7/1/2=10
> before the 2026-07-21 depdown refutation removed depdown from the flagged set (→7/1/1), then the
> LAST concordant flag `TT-createaccount-agreement` was RECLASSIFIED live-run 2026-07-21 (it was
> already FIRE 5/5 in the G3 head-to-head + a 2026-07-20 recap — the run was merely relocated to
> g3; verified against the raw agreement logs) → **8/1/0, zero capture-concordant flags remain**.
> The 8/1/1 split marker below is 33-era.
